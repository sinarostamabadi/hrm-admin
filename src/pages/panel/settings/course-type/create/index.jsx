...
import { createCourseType } from "../../../../../redux/actions/settings/course-type";
import * as Yup from "yup";

export const CreateCourseType = ({ onCloseModal, isReloadPage }) => {
  // ---------- store ----------
  ...
  const onSubmit = (values) => {
    dispatch(createCourseType(values, (status) => reloadPageHandler(status)));
  };
