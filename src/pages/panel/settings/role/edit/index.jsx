...
export const EditRole = () => {
  ...
  return (
    <>
      <div className="p-6 bg-white rounded-11 dark:bg-dark_custom-average-black">
        <MyForm
          initialValues={data}
        ...
        >
          <div className="w-full flex gap-x-2 items-center justify-between dark:bg-dark_custom-average-black">
            <h4 className="text-21 text-custom-dark font-bold dark:text-dark_custom-full-white">
