...
import { createWorkType } from "../../../../../redux/actions/settings/work-type";
import * as Yup from "yup";

export const CreateWorkType = ({ onCloseModal, isReloadPage }) => {
  // ---------- store ----------
  ...
  const onSubmit = (values) => {
    dispatch(createWorkType(values, (status) => reloadPageHandler(status)));
  };
  ...
  return (
    <>
      <div className="flex items-center justify-between p-4 border-b border-custom-gray-light dark:bg-dark_custom-average-black">
        <h4 className="text-18 font-bold dark:text-dark_custom-full-white">{t("page_title.create_work_type")}</h4>
