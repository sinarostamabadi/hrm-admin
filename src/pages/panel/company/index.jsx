...
import { BsBuildingFillGear, BsBuildingFillDown } from "react-icons/bs";
...
export const Company = () => {
  ...
  // ---------- store ----------
  const { info: companyData, loading } = useSelector((state) => state.companySlice);
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="group relative flex items-center justify-center gap-x-2">
          <span
            data-tooltip-id="company-project-tooltip"
            data-tooltip-content={t("tooltip.company_project")}
          ...
          >
            <BsBuildingFillGear color="#A1A5B7" size={16} />
            <Tooltip
              id="company-project-tooltip"
              style={{ backgroundColor: "#99a1b7" }}
            />
          </span>
          <span
            data-tooltip-id="company-project-tooltip"
            data-tooltip-content={t("tooltip.company_position")}
            className="p-2 rounded-md bg-custom-gray-light cursor-pointer"
            onClick={() =>
          ...
          >
            <BsBuildingFillDown color="#A1A5B7" size={16} />
            <Tooltip id="company-position-tooltip" />
          </span>
          <span
            className="p-2 rounded-md bg-custom-gray-light cursor-pointer"
  ...
  const deleteHandler = (id) => {
    ...
    axios
      .delete(api.CompanyApi.deleteCompany + id, { headers })
      .then((res) => {
