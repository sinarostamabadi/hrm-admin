...
export const Employee = () => {
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex gap-x-2">
          ...
          >
            <span className="p-2 rounded-md bg-custom-gray-light cursor-pointer">
              <svg
                width="17"
                height="17"
                viewBox="0 0 16 16"
  ...
  const deleteHandler = (id) => {
    ...
    axios
      .delete(api.EmployeeApi.deleteEmployee + id, { headers })
      .then((res) => {
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-y-1">
              ...
              <h4 className="text-14 flex gap-x-2 text-custom-gray-muted dark:text-dark_custom-light-white">
                {t("table.result")}
                <span className="text-custom-gray-200 font-bold dark:text-dark_custom-light-white">{count}</span>
              </h4>
            </div>
          </div>
          {loading ? (
